...
import { type AIProvider, resolverProvedor } from '../config';
...
export async function getOrgAIConfig(
  ...
  // Provedor e chave saem do mesmo lugar, para nao existir a chance de o
  // provedor ser um e a chave ser a de outro.
